...
#SBATCH --job-name=v3-checkpoint-test
#SBATCH --nodes=16
...
CHECKPOINT_LOAD_PATH=/scratch/project_462000353/europa-checkpoints/2kGBS-1024N
TENSORBOARD_PATH="tensorboard/v3-checkpoint-test.$SLURM_JOB_ID"
