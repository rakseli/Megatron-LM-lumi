...
#SBATCH --job-name=v3-data-debug-7B
#SBATCH --nodes=16
...
TENSORBOARD_PATH="tensorboard/v3-data-debug.$SLURM_JOB_ID"

export CUDA_DEVICE_MAX_CONNECTIONS=1

# sets TRAIN_DATA and VALIDATION_DATA
#source europa_data_flash.sh
#TRAIN_DATA="1.0 /flash/project_462000319/europa-final-merge/bg/culturax-hplt/merged-train.jsonl_text_document"
#TRAIN_DATA="1.0 /flash/project_462000319/europa-final-merge/fr/british-library/merged-train.jsonl_text_document"
TRAIN_DATA="1.0 /flash/project_462000319/europa-final-merge/en/reddit/merged-train.jsonl_text_document"
VALIDATION_DATA="1.0 /flash/project_462000319/europa-final-merge/bg/culturax-hplt/merged-validate.jsonl_text_document"
